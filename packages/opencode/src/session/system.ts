...
import PROMPT_DEFAULT from "./prompt/default.txt.ts"
import PROMPT_BEAST from "./prompt/beast.txt.ts"
import PROMPT_GEMINI from "./prompt/gemini.txt.ts"
import PROMPT_GPT from "./prompt/gpt.txt.ts"
import PROMPT_KIMI from "./prompt/kimi.txt.ts"

import PROMPT_CODEX from "./prompt/codex.txt.ts"
